...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/fusepy-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/fusepy-feedstock)
...
Once the `conda-forge` channel has been enabled, `fusepy` can be installed with:

```
conda install fusepy
```

It is possible to list all of the versions of `fusepy` available on your platform with:
